<div class="container">
    ...
    <div class="row">
        ...
        <ul class="nav nav-tabs" id="mytab">
          ...
          <li><a href="#skaititaji" data-toggle="tab">Objekta skaitītāji</a></li>
        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="pakalpojumi">
                ...
                <?php } elseif(Session::get_flash('error')) { ?>
                    <div class="col-md-5">
                        <div class="alert alert-error">
                            <p class="text-error"><?php echo Session::get_flash('error'); ?></p>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                <?php } ?>
                ...
                <?php $days = date_format(date_create($service->date_to), 'd.m.Y') - date('d.m.Y'); ?>
                <p><strong>Pakalpojums:</strong> <?php echo $service->name; ?> - <em><?php echo $service -> description; ?></em></p>
                ...
                <?php if(!empty($meters)) { ?>
                            <table class="table text-center">
                                ...
                                <tr>
                                    ...
                                    <td><button type="submit" class="btn btn-default">Iesniegt</button></td>
                                        </form>
                                    <td><a href="#" class="btn btn-link">Apskatīt</a></td>
                                </tr>
                                <?php } ?>
                            </table>
