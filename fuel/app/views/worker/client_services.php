        ...
        <?php } else { ?>
            ...
            <div class="modal fade" id="pievienot_skaititaju" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                ...
                <form id="add_meter" action="/darbinieks/klienti/skaititaji/pievienot" method="POST" role="form">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name='meter_type' type="text" class="form-control">
                            ...
                            <option value='F'>Ar filtru</option>
                            <option value='N'>Bez filtra</option>
                        </select>
                    </div>
...
<script>
    ...
    $('.meter_number').editable({
        type: 'text',
        url: '/darbinieks/klienti/skaititaji/labot/',
        params: {
            action: 'meter_number',
        },
